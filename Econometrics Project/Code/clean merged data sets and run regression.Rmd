...
#this creates a variable which records the post drought effects
  cleandat = cleandat|>
    group_by(fips)|>
    mutate(postdrought = ifelse(drought == 0 & lag(drought) == 1, 1,
                                ifelse(drought == 0 & lag(drought, n = 2) == 1, 2,
                               ifelse(drought == 0 & lag(drought, n = 3) == 1, 3, 0))))
...
#this creates a varible which records the pre drought effects
  cleandat = cleandat|>
    ...
    mutate(predrought = ifelse(drought == 0 & lead(drought, n = 1) == 1, 1,
                               ...
                               ifelse(drought == 0 & lead(drought, n = 3) == 1, 3, 0))))
