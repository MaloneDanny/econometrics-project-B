...
```{r}
#runs the regression
ols = lm(cleandat$net_migration ~ cleandat$lastyearprecip + cleandat$smalldrought + cleandat$lastyearprecip * cleandat$smalldrought + cleandat$fips + cleandat$statefip * cleandat$year)
summary(ols)
```