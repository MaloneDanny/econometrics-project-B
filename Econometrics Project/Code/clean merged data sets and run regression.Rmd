...
Create post and pre drought effects
```{r}
...
#this creates a varible which records the pre drought effects
  cleandat = cleandat|>
    group_by(fips)|>
    mutate(predrought = ifelse(smalldrought == FALSE & lead(smalldrought, n = 1) == TRUE, 1,
                                ifelse(smalldrought == FALSE & lead(smalldrought, n = 2) == TRUE, 2,
                               ifelse(smalldrought == FALSE & lead(smalldrought, n = 3) == TRUE, 3, 0))))
```
