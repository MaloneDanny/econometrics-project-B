...
n_distinct(countymaster2$fips)
  

n_distinct(countymaster$fips)

statemaster = cleandat|>
  filter(countyfip == "000")
```
...
filename = "C:/Users/malon/OneDrive/Documents/Rmasterdat.Rda"
save(cleandat, file = filename)
filename = "C:/Users/malon/OneDrive/Documents/Rmasterdat2.Rda"
...
ols = lm(cleandat$net_migration ~ cleandat$lastyearprecip + cleandat$smalldrought + cleandat$lastyearprecip * cleandat$smalldrought + cleandat$fips + cleandat$state * cleandat$year)
summary(ols)
